...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="h-screen overflow-x-hidden bg-[#F4F6FB] dark:bg-[#0D0B1F] flex flex-col transition-colors">
      ...
      <main className="flex-1 min-h-0 overflow-y-auto flex items-center justify-center px-4 sm:px-6 py-6">
        <div className="relative isolate w-full max-w-5xl">
          ...
          <div className="relative rounded-3xl bg-white dark:bg-[#1A1740] border border-gray-100 dark:border-white/10 transition-colors">
            ...
            <div className="pl-10 pr-5 sm:pl-16 sm:pr-12 py-7 sm:py-9">
              {children}
            </div>
          </div>
        </div>
      ...
      <footer className="w-full bg-white dark:bg-[#141130] border-t border-gray-100 dark:border-white/10 shrink-0 transition-colors">
