...
export const metadata: Metadata = { title: "Property for sale | Slickhood", description: "Browse active property for sale, published from managed Slickhood property records." };
