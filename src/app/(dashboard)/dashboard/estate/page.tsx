...
export default function EstatePage(){
 ...
 return <div className="mx-auto max-w-7xl space-y-6 p-4 sm:p-6"><div><p className="text-sm font-semibold uppercase tracking-[.18em] text-[#EF4217]">SlickHood Estates</p><h1 className="mt-1 text-3xl font-bold">Estate Management</h1><p className="text-muted-foreground">Manage homeowners, current ownership, preserved ownership history, service charges and estate operations.</p></div>
