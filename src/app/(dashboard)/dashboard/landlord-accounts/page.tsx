...
import { Loader2, Search, ShieldCheck, Shield, Wallet } from "lucide-react";
...
function LandlordAccountsOversightPage() {
  const { handleListAccounts, handleActivePaymentChannels } = useApi();
    ...
    <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 space-y-6">
      ...
      <div className="space-y-1.5">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Monitor payment destinations configured by landlords, estate managers, property sales, merchants, affiliates and insurance operations. SlickHood does not approve provider ownership.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-lg border grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <Select value={verifiedFilter} onValueChange={(v) => setVerifiedFilter(v as typeof verifiedFilter)}>
          <SelectTrigger>
            <SelectValue placeholder="Payment readiness" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="any">Readiness: Any</SelectItem>
            <SelectItem value="true">Ready: Yes</SelectItem>
            <SelectItem value="false">Ready: No</SelectItem>
          </SelectContent>
        </Select>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50 hover:bg-gray-50 border-b">
                    ...
                    <TableHead className="font-semibold text-[#141130]">Payment readiness</TableHead>
                    ...
                    <TableRow key={account.id} className="border-b last:border-0">
                      ...
                      <TableCell className="py-3">
                        ...
                        >
                          ...
                          {account.verified ? "Ready" : "Setup incomplete"}
                        </span>
                      </TableCell>
