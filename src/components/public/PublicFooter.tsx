...
export default function PublicFooter() { return <footer className="bg-[#08184A] text-white">
  <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:px-8">
    <div><Image src="/slicklogo.svg" width={142} height={40} alt="Slickhood" className="brightness-0 invert"/><p className="mt-5 max-w-sm text-sm leading-6 text-white/60">The connected platform for property, community, wealth and everyday services.</p></div>
