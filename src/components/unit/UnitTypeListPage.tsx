...
const statusTone = (code?: string) => {
  if (["AVAILABLE_RENTAL", "AVAILABLE_HOMEOWNER", "AVAILABLE_SALE", "OCCUPIED", "HOMEOWNER_ONBOARDED", "SOLD"].includes(code ?? "")) return "bg-green-100 text-green-800";
  if (["BUYER_PAYMENT_DUE", "RENT_PAYMENT_DUE", "ESTATE_PAYMENT_DUE", "TENANT_INVITED", "HOMEOWNER_INVITED", "BUYER_INVITED"].includes(code ?? "")) return "bg-amber-100 text-amber-800";
                    ...
                    <TableCell className="py-3">
                      <span
                        className={cn(
                          ...
                          unit.lifecycle ? statusTone(unit.lifecycle.code) : unit.occupied ? "bg-blue-100 text-blue-800" : "bg-green-100 text-green-800"
                        )}
