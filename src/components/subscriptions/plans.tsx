...
const CATEGORIES = ["LANDLORD", "ESTATE_MANAGEMENT", "PROPERTY_SALES", "SERVICE_PROVIDER", "ASSET_PORTFOLIO_MANAGER"];
const TIER_NAMES = new Set(["BRONZE", "SILVER", "GOLD", "PLATINUM"]);
const PRODUCT_ORDER = ["LANDLORD", "ESTATE_MANAGEMENT", "PROPERTY_SALES", "MY_WEALTH", "SERVICES", "SOKO", "GATE_MANAGEMENT_ADDON", "LISTING_ADDON", "PORTFOLIO_MANAGEMENT_ADDON"];
